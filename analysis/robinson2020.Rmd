...
if (params$clean) {
  ...
  unlink(here::here("analysis/figures/."), recursive = TRUE)
}
```
...
```{r treering-spds, results = 'hide'}
gc()
gc()

calibrate_tree_ring_dates <-
  function(x, timeRange = c(50000, 0)) {
    out <- list(
...
```{r gc3, echo = FALSE, message = FALSE, results='hide'}
# This chunk is here to deal with memory limits of Travis CI
rm(list = ls())
gc()
gc()
```
