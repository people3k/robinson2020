...
# Fix for deprecated ggplot2::expand_scale function
if (utils::packageVersion("ggplot2") >= "3.3.0") {
  expand_scale <- expansion
}

if (params$clean) {
  unlink(here::here("analysis/robinson2020.pdf"))
  unlink(here::here("analysis/robinson2020_cache"), recursive = TRUE)
  unlink(here::here("analysis/figures/."))
  # unlink(here::here("analysis/data/derived_data/."))
}
```
...
if (!file.exists(
  ...
  download.file("https://core.tdar.org/filestore/download/455460/567756",
    destfile = here::here("analysis/data/raw_data/robinson_et_al_2020_radiocarbon.csv")
  )
...
\newpage
\beginsupplement
# Supplementary Material: Cut-width sensitivity for temporal binning {- #supp}
